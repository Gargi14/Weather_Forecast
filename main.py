...
#key: 05c401f56853975cdc525b08df062348
...
def get_weather(city):
    weather_key='05c401f56853975cdc525b08df062348'
...
heading_title=tk.Label(bg_lbl,text="Weather Forecast of more than 200,000 cities!!",fg='red',bg='sky blue',font=('times new roman',16,'bold'))
...
result=tk.Label(frame_two,font=('times new Roman',20),bg='white',justify='left',anchor='nw')
